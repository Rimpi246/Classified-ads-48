...
Data used for map geo-locations is in [GEOJSON format](https://en.wikipedia.org/wiki/GeoJSON). In [deployment step](https://github.com/bacloud14/Classified-ads-48#deployment) data is **downloaded, validated, and copied** for front and back-end.  
