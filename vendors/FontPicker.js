 ...
 result.done ? resolve(result.value) : new P(function(resolve) {
  ...
  function getFontList(apiKey) {
    return __awaiter(this, void 0, void 0, function() {
      let url; let response; let json; let fontsOriginal;
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            return [2, fontsOriginal.map(function(fontOriginal) {
              const family = fontOriginal.family; const subsets = fontOriginal.subsets; const others = __rest(fontOriginal, ['family', 'subsets']);
  ...
  function getStylesheet(fonts, scripts, variants, previewsOnly) {
    return __awaiter(this, void 0, void 0, function() {
      let url; let variantsStr; let familiesStr; let familyNamesConcat; let downloadChars;
      return __generator(this, function(_a) {
  ...
  function loadFontPreviews(fonts, scripts, variants, selectorSuffix) {
    return __awaiter(this, void 0, void 0, function() {
      let fontsArray; let fontsToFetch; let response; let fontStyles;
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
  ...
  const FontManager = (function() {
    function FontManager(apiKey, defaultFamily, _a, onChange) {
      ...
      const _b = _a.pickerId; const pickerId = _b === void 0 ? OPTIONS_DEFAULTS.pickerId : _b; const _c = _a.families; const families = _c === void 0 ? OPTIONS_DEFAULTS.families : _c; const _d = _a.categories; const categories = _d === void 0 ? OPTIONS_DEFAULTS.categories : _d; const _e = _a.scripts; const scripts = _e === void 0 ? OPTIONS_DEFAULTS.scripts : _e; const _f = _a.variants; const variants = _f === void 0 ? OPTIONS_DEFAULTS.variants : _f; const _g = _a.filter; const filter = _g === void 0 ? OPTIONS_DEFAULTS.filter : _g; const _h = _a.limit; const limit = _h === void 0 ? OPTIONS_DEFAULTS.limit : _h; const _j = _a.sort; const sort = _j === void 0 ? OPTIONS_DEFAULTS.sort : _j;
      if (onChange === void 0) {
        onChange = function() { };
      }
      this.fonts = new Map();
    ...
    FontManager.prototype.init = function() {
      return __awaiter(this, void 0, void 0, function() {
        let fonts; let _loop_1; let this_1; let i; let state_1; let fontsToLoad;
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              _loop_1 = function(i) {
                ...
                if (!this_1.fonts.has(font.family) &&
                                  ...
                                  this_1.options.scripts.every(function(script) {
  ...
  const FontPicker = (function() {
    ...
    FontPicker.prototype.generateUI = function(sort) {
      const _this = this;
      const selectorSuffix = this.fontManager.selectorSuffix;
