...
// const text = fs.readFileSync(path.resolve(__dirname, '../data/arabic.txt'));
// const arabic = text.toString('utf-8').split('\n').slice(0, 245);
// const english = require('../node_modules/compatto/cjs/dictionary.cjs').dictionary;
// const {
//   compress: compressEn,
//   decompress: decompressEn,
// } = compatto({
//   dictionary: english,
// });
// const {
//   compress: compressAr,
//   decompress: decompressAr,
// } = compatto({
//   dictionary: arabic,
// });

// ops.compressEn = compressEn;
// ops.decompressEn = decompressEn;
// ops.compressAr = compressAr;
// ops.decompressAr = decompressAr;
